...
```{r dim2, include=TRUE, message=FALSE, fig.cap='A histogram of distribution of Mean Time counts'}
...
```{r dim4, include=TRUE, fig.cap='A boxplot of the spreads of Mean Time for Correct and Incorrect Responses'}
...
```{r dim5, include=TRUE, fig.cap='A barplot of the average percent Correct and Incorret responses for Female and Male participants - using geom_bar()'}
total_n_trials <- 96
...
```{r dim6, include=TRUE, fig.cap='A barplot of the average percent Correct and Incorret responses for Female and Male participants - using geom_col()'}
