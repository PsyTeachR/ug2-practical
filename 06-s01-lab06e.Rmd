...
#### Task 1
```{r inclass-hidden solution, warning = FALSE, echo = FALSE, message = FALSE}
...
`r hide("Possible Solution to Task 1")`
...
`r hide("Possible Solution to Task 2")`
...
`r hide("Possible Solution to Task 4")`
```{r}
...
```{r img-lab6-figure2a, echo = FALSE, out.width='50%', fig.cap = "Figure 7"}
