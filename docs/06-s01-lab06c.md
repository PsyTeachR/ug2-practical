...
### InClass Task 3: Creating a Figure
...
## `tidy()` takes information from a test and turns it into a table. 
## Run the t.test with and without piping into tidy to see what it does differently.
...
Table: (\#tab:ch6-task4-table)Table Caption
...
Table: (\#tab:lab6-task4-table2)Table Caption
