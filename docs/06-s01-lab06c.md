...
1. Open a new script and call `broom` and `tidyverse` into your library. **Note:** Order is important when calling multiple libraries - if two libraries have a function named the same thing, R will use the function from the library loaded in last.
...
<li>This website is also incredibly useful and one to save for anytime you need to use recode(): <a href="https://debruine.github.io/posts/recode/" class="uri">https://debruine.github.io/posts/recode/</a>.</li>
...
Replace the `NULL`s below to create a very basic version of this figure. You did something like this for the Lab 5 assignment and again in the Lab 3 Visualisation tasks.
