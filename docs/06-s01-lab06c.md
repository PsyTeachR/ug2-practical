...
### InClass Task 1: Evaluators {#Ch6InClassQueT1}
...
<br>    
### InClass Task 2: Ratings {#Ch6InClassQueT2}
...
### InClass Task 3: Creating a Figure {#Ch6InClassQueT3}
...
<br>
### InClass Task 4: t-tests {#Ch6InClassQueT4}
...
Table: (\#tab:ch6-task4-table)The t-test output of those in the intellect condition.
...
Table: (\#tab:table-test)Example table with kable.
