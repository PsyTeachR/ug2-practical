...
<div class='webex-solution'><button>Portfolio Point - All the different names for one thing!</button>
...
<div class="figure" style="text-align: center">
<img src="06-s01-lab06c_files/figure-html/ch6-fig7-solution-1.png" alt="A basic solution to Figure 7" width="100%" />
...
<div class='webex-solution'><button>Portfolio Point - A vs B or B vs A in a t-test?</button>
