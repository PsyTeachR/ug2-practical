...
<p>If you know any three of these four elements (power, alpha, effect size, n) you can calculate the fourth. We will save further discussion of power until Lab 8 but if you want to read ahead then this blog is highly recommended: &lt;a href=“<a href="https://pigee.wordpress.com/2016/09/13/the-power-dialogues/" class="uri">https://pigee.wordpress.com/2016/09/13/the-power-dialogues/</a>”, target =&quot;_blank&quot;&gt;The Power Dialogues</a>.</p>
</div>
...
Table: (\#tab:ch6-preclass-nsdata)Data for 22 Participants on Posner task
