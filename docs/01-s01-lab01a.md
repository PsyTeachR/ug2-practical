...
<p>Knit is what we say when we want to compile our R Markdown file into either a webpage, PDF, or a Word document. Often in the labs you will hear someone say, “Have you tried knitting it?” or “What happens when you knit it?”. This simply means what happens when you try turning your file into a pdf or webpage.&quot;)</p>
</div>
...
4. You write your report in plain text, a non-proprietary format that is easy to share, and it's not necessary to learn any new coding syntax such as HTML.  
