...
* To check you have completed this Task correctly, enter the appropriate values into the boxes. 
    - This dataset has: <input class='solveme nospaces' size='1' data-answer='["4"]'/> columns by <input class='solveme nospaces' size='3' data-answer='["150"]'/> rows and <input class='solveme nospaces' size='2' data-answer='["75"]'/> participants.
...
<div class='solution'><button>Normal or not - Outliers vs DataPoints - Our Answer</button>
...
<ul>
<li>Do not forget to state <code>paired = TRUE</code> or you will run a between-subjects t-test</li>
