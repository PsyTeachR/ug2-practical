...
<!--
I'm not sure a violin plot of the two conditions is the ideal visualization here, because again, we're interested in the difference scores, and the violin plot shows all the points as independent. So I suggest removing this visualization. The histogram is sufficient.
-DJB
-->
...
<div class="info">
<p>To pull out the <code>Twelve</code> and <code>Thirteen</code> columns to pass as <code>x</code> and <code>y</code>, you can use: <code>lates %&gt;% pull(Twelve)</code> and <code>lates %&gt;% pull(Thirteen)</code>.</p>
<ul>
