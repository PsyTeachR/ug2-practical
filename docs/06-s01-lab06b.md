...
* The number of participants that have a mean reaction time for valid trials greater than that of the original paper is: <select class='webex-select'><option value='blank'></option><option value=''>6</option><option value=''>10</option><option value='answer'>16</option><option value=''>17</option></select>
