...
As a small group, have a look at the data in `responses` to see if you think it is Tidy or not and answer the following question: The data in `responses` is in <select class='webex-select'><option value='blank'></option><option value=''>Tidy</option><option value=''>Long</option><option value='answer'>Wide</option></select> format
