...
<div class="info">
<p>The two main things to know about working with <code>ggplot</code> is that:</p>
...
<p><code>ggplot()</code> is an incredibly powerful package that is used by a whole range of industries, including newspapers and mainstream media outlets, as it can do quite sophisticated images.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-s01-lab03b_files/figure-html/dim2-1.png" alt="A histogram of distribution of Mean Time counts" width="100%" />
<p class="caption">(\#fig:dim2)A histogram of distribution of Mean Time counts</p>
</div>
...
<p>As the y axis is the count of the values on the x axis, the most common overall response time can be found reading the highest column of the data. For this distribution this looks to be around 2500 milliseconds or 2.5 seconds.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-s01-lab03b_files/figure-html/dim4-1.png" alt="A boxplot of the spreads of Mean Time for Correct and Incorrect Responses" width="100%" />
<p class="caption">(\#fig:dim4)A boxplot of the spreads of Mean Time for Correct and Incorrect Responses</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-s01-lab03b_files/figure-html/dim5-1.png" alt="A barplot of the average percent Correct and Incorret responses for Female and Male participants - using geom_bar()" width="100%" />
<p class="caption">(\#fig:dim5)A barplot of the average percent Correct and Incorret responses for Female and Male participants - using geom_bar()</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="03-s01-lab03b_files/figure-html/dim6-1.png" alt="A barplot of the average percent Correct and Incorret responses for Female and Male participants - using geom_col()" width="100%" />
<p class="caption">(\#fig:dim6)A barplot of the average percent Correct and Incorret responses for Female and Male participants - using geom_col()</p>
</div>
