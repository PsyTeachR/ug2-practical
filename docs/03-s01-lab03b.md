...
* Looking at the histogram, what can you say about the overall shape of the distribution? <select class='solveme' data-answer='["the data looks reasonably normally distirbuted"]'> <option></option> <option>the data looks reasonably normally distirbuted</option> <option>the data looks positively skewed</option> <option>the data looks negatively skewed</option></select>
