...
2. `n` tells you the number of blocks in which the corresponding number of face trials appeared, e.g. in 209 blocks there were 15 face trials. (Remember this is sampled data so your values may be different!). 
...
2. We only have data for 24 potential different number of face trials within a block. Why does this value not stretch from 0 to 60, or at least have more potential values than 24?
