...
* From the options, what type of data is the variable `Angle`, found in the dataframe `menrot`? <select class='solveme' data-answer='["double/numerical"]'> <option></option> <option>character</option> <option>integer</option> <option>double/numerical</option></select>
