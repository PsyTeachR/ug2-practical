...
<div class="info">
<p>This value appears in column <code>err</code>, where <code>i</code> equals 3 and <code>j</code> equals 2. This can be thought of the unique difference for that participant from the sample mean and group mean.</p>
</div>
...
<div class="info">
<ul>
<li>You will need some wrangling functions so on't forget to load the tidyverse</li>
