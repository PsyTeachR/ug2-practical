...
<img src="04-s01-lab04e_files/figure-html/unnamed-chunk-2-1.png" alt="Distribution of IQ scores with mean = 100, sd = 10" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-2)Distribution of IQ scores with mean = 100, sd = 10</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="04-s01-lab04e_files/figure-html/unnamed-chunk-3-1.png" alt="Normal Distribution shown on a scale of -10 to 10, with a mean = 0, sd = 1" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-3)Normal Distribution shown on a scale of -10 to 10, with a mean = 0, sd = 1</p>
</div>
