...
<div class='solution'><button>Solution Binomial Task</button>
...
<div class='solution'><button>Solution Binomial Quickfire Questions</button>
...
```
##  int [1:10000] 50 58 50 43 50 51 51 40 44 51 ...
```
