...
According to the one-sample t-test these participants are responding in the same manner as the participants from the original study, and as such, it may be safe to assume that the recruitment process of our pilot experiment is working well.
...
## # A tibble: 3 x 11
## # Groups:   Category [3]
##   Category estimate estimate1 estimate2 statistic p.value parameter
##   <chr>       <dbl>     <dbl>     <dbl>     <dbl>   <dbl>     <dbl>
## 1 hire         1.83      4.71      2.89      2.62 0.0127         37
## 2 impress~     1.89      5.97      4.07      2.85 0.00709        37
## 3 intelle~     1.99      5.63      3.65      3.53 0.00114        37
