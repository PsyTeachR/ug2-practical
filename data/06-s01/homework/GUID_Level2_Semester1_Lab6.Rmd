---
title: "Psych 2A Lab 6: Independent samples t-test Assignment"
...
Figure 2A from the original paper is shown on the Moodle assignment:

* Write code in the t4 code chunk to reproduce a version of Figure 2a - shown on Moodle.  Before you create the plot, replace the `NULL` to make a table called `crt_means` with the mean and standard deviation of the number of `CorrectAnswers` for each group. Use `crt_means` as the source data for the plot.  
