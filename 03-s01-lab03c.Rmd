...
* From the options, what type of data is the variable `Angle`, found in the dataframe `menrot`? `r mcq(c("character",answer = "integer","numeric"))`
...
* In both sex, mean reaction time `r mcq(c("decreases with",answer = "increases with","is unaffected by"))` angle of rotation.
