...
3. When renaming, first state the new variable name and then designate this to the old variable name. i.e. `rename(data, new_column_name = old_column_name)`. If the old column is a number, put it in backticks e.g. Five = backtick 5 backtick (but remember to actually use `s)
