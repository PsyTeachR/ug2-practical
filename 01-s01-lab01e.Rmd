...
```{r lab1-task3-example, eval = FALSE, verbatim = 'r load_data, echo = FALSE, warning = FALSE, message = FALSE'}
...
Worth noting that, in basic R Scripts, `#` at the start of the line would result in turning the line into a `r glossary("comment")`. Here, in R Markdown,  `#` sets the header size much like a Word document header
...
```{r lab1-task8-example, eval = FALSE, verbatim = 'r table, echo = FALSE'}
...
```{r lab1-task9-example, eval = FALSE, verbatim = 'r plot, include = TRUE'}
