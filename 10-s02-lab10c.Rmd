...
* **Check your thinking:** the type of data in this analysis is most probably `r mcq(c("ratio", answer = "interval","ordinal", "nominal"))` as the data is `r mcq(c(answer = "continuous","discrete"))` and there is unlikely to be a true zero
