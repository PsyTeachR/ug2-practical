...
Immediately below the header information you will see the default setup **code chunk** as shown in Figure \@ref(fig:img-setup-chunk). Most of the time you will not edit the information in this chunk and you will add information, text, and code, below it.  

```{r img-setup-chunk, echo = FALSE, out.width='75%', fig.cap = "The defualt setup code chunk"}
...
```{r img-the-knit-button, echo = FALSE, out.width='50%', fig.cap = "The knit button. Clicking this will knit your file."}
...
```{r img-rmd-summary1, echo = FALSE, out.width='50%', fig.cap = "The Rmd Summary 1"}

knitr::include_graphics("images/s01-lab01/preclass/rmd_summary.png")
```
...
```{r img-rmd-summary2, echo = FALSE, out.width='50%', fig.cap = "The Rmd Summary 2"}
...
```{r img-results-hide, echo = FALSE, out.width='50%', fig.cap = "The Results Hide Rule"}
...
```{r img-bold-example, echo = FALSE, out.width='50%', fig.cap = "Bold Example"}

knitr::include_graphics("images/s01-lab01/preclass/inlinecoding2.PNG")
```
...
```{r img-header-levels, echo = FALSE, out.width='50%', fig.cap = "Inputting different Header levels using #s"}
...
<span style="font-size: 22px; font-weight: bold; color: var(--green);">Preclass Activity Complete!</span>
