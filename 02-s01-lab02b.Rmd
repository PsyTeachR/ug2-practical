...
* Run the first two lines of code in the box above to create `pong_data_hits` and then enter the number of hits made with the small paddle (50) and the red color background in this box: `r fitb(pong_data2_hits_red_small %>% pull(total_hits))`
...
We have now recapped a number of functions and verbs that you will need as the semester goes on.  You will use them in the lab next week so be sure to go over these and try them out to make yourself more comfortable with them. Remember to also start looking back at your first year labs and remembering some of the work you did there.  If you have any questions please post them on the forums. Finally, don't forget to add any useful information to your Portfolio before you leave it too long and forget. **Happy Wrangling!**
