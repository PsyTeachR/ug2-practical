...
Over a sequence of four trials, with one trial for each sound, and sampled **without replacment**, what is the probability of the following sequence of sounds: person, tone, animal, vehicle? Replace the `NULL` in the t3 code chunk with either mathematical notation or a single value.

<!--
This question didn't make sense because you said "without replacement" and yet had person appearing twice, which isn't possible
-->
...
<!--
Had to change this task because it is not sensible to ask about the probability
of an *exact* score of 90 on a continuous distribution
-->
