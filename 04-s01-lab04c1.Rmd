...
```{r normplot1, eval = TRUE, echo = FALSE}
...
```{r, echo=FALSE, results='asis'}
cat("The counterpart functions all start with the same letter, d, p, q, it is just the distribution name that changes, `binom`, `norm`, `t` - though we haven't quite come across the t-distribution yet.  
...
```{r ND_example, include = TRUE, message=FALSE}
