...
3. Now put that into your `permute()` function making the necessary adjustments to the code so it starts `x %>%...` instead of `dat %>%...`. Again `x` should be in the function and not `dat`.
")
```
`r unhide()`
<br>
