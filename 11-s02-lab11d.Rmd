...
if (!identical(names(dmx), names(dsetup)) || 
  ...
  warning("If this warning appears in the output, you have not yet defined 'dmx' properly. Check column names (including capitalization), column data types, and table structure.")
}
```
