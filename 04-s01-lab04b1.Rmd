...
``` {r binom-plot1, echo=FALSE, eval=TRUE, fig.cap = 'Probability Distribution of Number of Heads in 10 Flips'}
...
``` {r binom-plot2, echo =FALSE, eval = TRUE, fig.cap = 'Probability Distribution of Number of Heads in 10 Flips'}
...
``` {r binom-plot3, echo =FALSE, eval = TRUE, fig.cap = 'Probability Distribution of Number of Heads in 10 Flips'}
